...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/assets/global.css?v=night-watch-jumpscare-20260616" />
  ...
  <body class="game-site">
    ${body}
    <script type="module" src="/assets/arcade.js?v=night-watch-jumpscare-20260616"></script>
  </body>
</html>
`;
}
