...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/assets/global.css?v=neondash-fair-spikes-20260615" />
  ...
  <body class="game-site">
    ${body}
    <script type="module" src="/assets/arcade.js?v=neondash-fair-spikes-20260615"></script>
  </body>
</html>
`;
}
